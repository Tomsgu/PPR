...
then
  ...
  #  -------------------------------------------------------------------------
  mpirun -np $NSLOTS ${MY_PARALLEL_PROGRAM} #-stdout ./utils/output.out -stderr ./utils/error.out
else
  #  -------------------------------------------------------------------------
  # | Set network communication openMPI between nodes - Ethernet (tcp)        |
  #  -------------------------------------------------------------------------
  mpirun --mca btl tcp,self -np $NSLOTS ${MY_PARALLEL_PROGRAM} #-stdout ./utils/output.out -stderr ./utils/error.out
fi
